...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vusion_vusion_cli_node_modules_vusion_vue_loader_lib_template_compiler_index_id_data_v_ebb37b06_hasScoped_false_vusion_vusion_cli_node_modules_vusion_vue_loader_lib_selector_type_template_index_0_node_modules_vue_markdown_loader_lib_markdown_compiler_js_raw_README_md__ = __webpack_require__(691);
...
var Component = normalizeComponent(
  __vue_script__,
  __WEBPACK_IMPORTED_MODULE_0__vusion_vusion_cli_node_modules_vusion_vue_loader_lib_template_compiler_index_id_data_v_ebb37b06_hasScoped_false_vusion_vusion_cli_node_modules_vusion_vue_loader_lib_selector_type_template_index_0_node_modules_vue_markdown_loader_lib_markdown_compiler_js_raw_README_md__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('u-article', [_c('h1', [_vm._v("表单")]), _vm._v(" "), _c('h2', [_vm._v("示例")]), _vm._v(" "), _c('h3', [_vm._v("基本形式")]), _vm._v(" "), _c('div', {
  ...
  }, [_c('u-textarea')], 1), _c('u-form-item', [_c('u-button', {
    attrs: {
      "color": "primary"
    }
    ...
    pre: true
  }, [_vm._v("message")]), _vm._v("：验证不通过时的消息提示")]), _vm._v(" "), _c('li', [_vm._v("...")])]), _vm._v(" "), _c('p', [_vm._v("下面举个例子，一个用户名输入框的验证包含以下规则：")]), _vm._v(" "), _c('ol', [_c('li', [_vm._v("必须输入用户名，失焦验证")]), _vm._v(" "), _c('li', [_vm._v("以字母开头，实时验证")]), _vm._v(" "), _c('li', [_vm._v("字母、数字或中划线组成，实时验证")]), _vm._v(" "), _c('li', [_vm._v("以字母或数字结尾，失焦验证")]), _vm._v(" "), _c('li', [_vm._v("4~12个字符，失焦验证")])]), _vm._v(" "), _c('pre', {
    pre: true,
    attrs: {
      "class": "hljs lang-vue"
    }
    ...
    pre: true
  }, [_vm._v("u-form")]), _vm._v("中汇总传入。")]), _vm._v(" "), _c('pre', {
    pre: true,
    attrs: {
      "class": "hljs lang-vue"
    }
    ...
    pre: true
  }, [_vm._v("email")]), _vm._v(": Must be of type email.")])]), _vm._v(" "), _c('p', [_vm._v("其它请参见"), _c('a', {
    attrs: {
      "href": "https://github.com/yiminghe/async-validator"
    }
  }, [_vm._v("async-validator")]), _vm._v("。")]), _vm._v(" "), _c('h3', [_vm._v("触发方式")]), _vm._v(" "), _c('p', [_vm._v("表单验证行为按照实时性通常可以分为三种：提交验证、失焦验证、实时验证，分别对应验证规则"), _c('code', {
    pre: true
    ...
    pre: true
  }, [_vm._v("click")]), _vm._v("事件。示例如下：")]), _vm._v(" "), _c('pre', {
    pre: true,
    attrs: {
      "class": "hljs lang-vue"
    }
    ...
    pre: true
  }, [_vm._v("blur")]), _vm._v("事件。示例如下：")]), _vm._v(" "), _c('pre', {
    pre: true,
    attrs: {
      "class": "hljs lang-vue"
    }
    ...
    pre: true
  }, [_vm._v("input+blur")]), _vm._v("。")]), _vm._v(" "), _c('p', [_vm._v("下面的例子中，对用户名长度和邮箱格式的判断为实时验证。其中邮箱的验证没有采用实时与失焦叠加的方式，可以发现这种方式不是很合理。")]), _vm._v(" "), _c('pre', {
    pre: true,
    attrs: {
      "class": "hljs lang-vue"
    }
  ...
  }, [_vm._v("script")]), _vm._v(">")]), _vm._v("\n")])]), _vm._v(" "), _c('h3', [_vm._v("必填项有内容可点")]), _vm._v(" "), _c('p', [_vm._v("当表单中所有必填项有内容时，表单提交按钮才可点。")]), _vm._v(" "), _c('p', [_vm._v("表现为根据表单中必填项是否为空，使用计算属性来实时判断提交按钮是否可点。并且在这种情况下，通常采用三种验证相结合的方式。")]), _vm._v(" "), _c('pre', {
    pre: true,
    attrs: {
      "class": "hljs lang-vue"
    }
  ...
  }, [_vm._v("script")]), _vm._v(">")]), _vm._v("\n")])]), _vm._v(" "), _c('h3', [_vm._v("所有项内容正确可点")]), _vm._v(" "), _c('p', [_vm._v("当表单中所有项内容均符合要求时，表单提交按钮才可点。")]), _vm._v(" "), _c('p', [_vm._v("表现为根据每个表单控件的验证结果，使用计算属性来实时判断提交按钮是否可点。这种情况下，一般就不需要进行提交验证了。")]), _vm._v(" "), _c('pre', {
    pre: true,
    attrs: {
      "class": "hljs lang-vue"
    }
