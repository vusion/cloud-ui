...
namespace nasl.ui {
    ...
    export class UCollapse extends VueComponent {
...
- 关闭：可同时展开多个面板项。`,
        ...
        onExpand: (event: nasl.ui.CollapseEvent) => void;

        @Event({
            title: '折叠时',
            description: '折叠某面板时触发',
        })
        onCollapse: (event: nasl.ui.CollapseEvent) => void;
    ...
    export class UCollapseItem extends VueComponent {
