...
<template>
<u-linear-layout>
    <u-select v-model="value" placeholder="自定义选中展示" field="select">
...
export default {
    data() {
        return {
            value: '',
            list: [
                { text: 'Java', value: 'java', description: '这是java', select:'选中的是Java'},
                { text: 'Python', value: 'python', description: '这是python', select:'选中的是Python' },
