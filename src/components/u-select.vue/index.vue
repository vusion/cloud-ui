...
<div :class="$style.root" :color="color" :readonly="readonly" :disabled="currentDisabled" :opened="popperOpened"
    ...
    <m-popper :class="$style.popper" ref="popper" :color="color" :placement="placement" :append-to="appendTo" :disabled="readonly || currentDisabled"
        :style="{ width: currentPopperWidth? currentPopperWidth+ 'px': '100%'}"
...
export default {
    ...
    watch: {
        ...
        appendTo(appendTo) {
            if (appendTo === 'body') {
                this.currentPopperWidth = this.popperWidth ? this.popperWidth : this.$el && this.$el.offsetWidth;
            } else {
    ...
    mounted() {
        ...
        if (this.appendTo === 'body') {
            this.currentPopperWidth = this.popperWidth ? this.popperWidth : this.$el.offsetWidth;
        } else {
            this.currentPopperWidth = '100%';
        }
    },
