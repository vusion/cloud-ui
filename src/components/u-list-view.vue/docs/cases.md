...
<template>
    <u-linear-layout direction="vertical">
        <u-linear-layout><u-button @click="changeList">变换list值</u-button></u-linear-layout>
        <u-list-view v-model="value" :data-source="list" :page-size="20" :page-number="1" :pageable="true" :show-sizer="true" :page-size-options="[10,20,50]"></u-list-view>
    </u-linear-layout>
</template>
<script>
export default {
