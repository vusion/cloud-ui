module.exports = [
    ...
    { group: 'Navigation', show: true, name: 'u-crumb', alias: '面包屑' },
    { group: 'Container', show: true, name: 'u-panel', alias: '面板' },
    { group: 'Container', show: true, name: 'u-collapse', alias: '折叠面板' },
    { group: 'Container', show: true, name: 'u-card', alias: '卡片' },
    ...
    { group: 'Selector', show: true, name: 'u-tree-view-new', alias: '树型列表(组件)' },
