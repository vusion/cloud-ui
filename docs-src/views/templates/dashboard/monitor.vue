        ...
        <div :class="$style.row">
            ...
            <div :class="$style.bd">
                <div :class="$style.content">
                    <u-line-chart border legend :title="title" :x-axis="xaxis" :y-axis="yaxis" :series="series" :data="monitorData" :smooth="smooth" :title-align="titleAlign" height="350px" :loading = "loading">
        ...
        <div :class="$style.row">
            ...
            <div :class="$style.bd">
                <div :class="$style.chart">
                    <u-line-chart border legend :title="title1" :x-axis="xaxis" :y-axis="yaxis1" :series="series1" :data="vmData" :smooth="smooth" height="350px">
                ...
                <div :class="$style.chart">
                    <u-line-chart border legend :title="title2" :x-axis="xaxis" :y-axis="yaxis1" :series="series2" :data="vmData" :smooth="smooth" height="350px">
                        <template v-for="(item,index) in vmData">
                            <div :slot="'tooltipTemplate'+index">
                                <p>{{ item.week }}</p>
                                <p>内存 {{ item.mem }}%</p>
